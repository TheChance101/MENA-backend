...
enum class Country(
    ...
    JORDAN("identity.country.jordan", "+962", "JO", "🇯🇴", "^(0)?7[789]\\d{7}$"),
    ...
    PALESTINE("identity.country.palestine", "+970", "PS", "🇵🇸", "^(0)?5[69]\\d{7}$"),
    ...
    SUDAN("identity.country.sudan", "+249", "SD", "🇸🇩", "^(0)?(9[0125679])\\d{7}$"),
