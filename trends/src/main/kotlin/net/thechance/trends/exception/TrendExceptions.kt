...
class TrendUrlSigningException(message: String): TrendExceptions(message)

class TrendUserUnauthorizedException: TrendExceptions("Unauthorized to do this action user")